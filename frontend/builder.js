...
const CONFIG_SECOES = {
  ...
  certificados: {
    ...
    campos: [
      ...
      { nome: "em_andamento", label: "Em andamento (ainda não concluí)", tipo: "checkbox", controlaCampo: "periodo", virtual: true },
      { nome: "periodo", label: "Período", tipo: "text", opcional: true, ajuda: "Ex: 2025", mostraSe: { valor: false } },
    ],
